 ...
 */
object GaitServiceFactory {

    fun makeApiConfiguration(): ApiConfiguration {
        return ApiConfiguration("https://gait-unicamp.herokuapp.com/", "api_key")
    }

    fun makeGaitService(apiConfiguration: ApiConfiguration, isDebug: Boolean): GaitService {
    ...
    fun makeMovieService(apiConfiguration: ApiConfiguration, okHttpClient: OkHttpClient, gson: Gson): GaitService {
        val retrofit = makeRetrofit(apiConfiguration, okHttpClient, gson)
        return retrofit.create(GaitService::class.java)
    }
